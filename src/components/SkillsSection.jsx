...
const skills = [
  ...
  {name:"Prisma",level:100,category:"backend"},
   {name:"Drizzle",level:100,category:"backend"},
  ...
  //Ai
    { name: "Langchain", level: 100, category: "AI" },
  { name: "Langraph", level: 100, category: "AI" },
  { name: "nlp", level: 100, category: "AI" },
    { name: "LLm api's", level: 100, category: "AI" },
    {name:"convex",level:100,category:"AI"},
    {name:"n8n",level:100,category:"AI"},

  //bots
    { name: "RAG chatbots", level: 100, category: "Chatbots" },
    {name:"telegram bots",level:100,category:"Chatbots"},
    {name:"discord bots",level:100,category:"Chatbots"}

];

const categories = ["all", "frontend", "backend", "tools","AI","Chatbots"];
